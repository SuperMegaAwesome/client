...
var handler = StripeCheckout.configure({
  ...
  token: function token(_token) {
    ...
    var ajaxTokenPost = function ajaxTokenPost(theToken) {
    ...
    var qty = $('.cart-quant').val();
    cartArray[0].quantity = qty;
    var price = cartArray[0].price.replace('$', '');
    var data = {
      cart: {
        pastOrder: cartArray,
    ...
    };api.updateOrder(data).then(function () {
      ajaxTokenPost(_token);
    }).then(function () {
      ...
      $('#cart-message').text('Card Declined').css('color', 'red');
    });
  }
...
var onSignUp = function onSignUp(event) {
  ...
  var password = $('.sign-up input[name="credentials[password]"]').val();
  var passConfirm = $('.sign-up input[name="credentials[password_confirmation]"]').val();
...
var onSignOut = function onSignOut(event) {
  event.preventDefault();
  api.signOut().then(ui.cancelOrderSuccess).then(ui.signOutSuccess).fail(ui.signOutFailure);
};

var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.changePassword(data).then(ui.changePasswordSuccess).fail(ui.changePasswordFailure);
...
// --------------------------------- Cart Events ---------------------------------
var onShowModalActions = function onShowModalActions(event) {
  $('#order-history').html('');
...
var addToCart = function addToCart(event) {
  var name = $(event.target).parents('.product').find('.prod-name').text();
  var price = $(event.target).parents('.product').find('.product-price').text();

  var tableVal = '<tr class="cart-item"><td>' + name + '</td><td><input type=number class="cart-quant" min=1 value=1></td><td>' + price + '</td><td><button type="button" class="update-item-btn">Update</span></td><td><button type="button" class="delete-btn">Remove</span></td></tr>';
...
var onCheckout = function onCheckout() {
  ...
  api.checkout(data).then(ui.checkoutSuccess).catch(ui.checkoutFailure);
};
...
var onCancelOrder = function onCancelOrder(event) {
  // Show update and delete buttons upon order cancel event so that modifications can be made to the cart
  $('.update-item-btn').show();
  $('.delete-btn').show();
  stripeTotal = 0;
  api.cancelOrder().then(ui.cancelOrderSuccess).catch(ui.cancelOrderFailure);
};

var onHiddenModalActions = function onHiddenModalActions(event) {
...
var onGetHistory = function onGetHistory(event) {
  event.preventDefault();
  api.getHistory().then(ui.getHistorySuccess).catch(ui.getHistoryFailure);
};
// --------------------------------------------------------------------
...
var store = __webpack_require__(4);
var historyTemplate = __webpack_require__(16);
...
var checkoutFailure = function checkoutFailure() {
  $('#cart-message').text('Error checking out').css('color', 'red');
};

var updateOrderSuccess = function updateOrderSuccess() {
  store.cart = null;
  var resetVal = 0.00;
  document.getElementById('cart-total').value = resetVal.toFixed(2);
  $('.cart-item').remove();
...
var updateOrderFailure = function updateOrderFailure() {
  $('#cart-message').text('Error updating order').css('color', 'red');
};

var cancelOrderSuccess = function cancelOrderSuccess() {
  store.cart = null;
  var resetVal = 0.00;
  document.getElementById('cart-total').value = resetVal.toFixed(2);
  $('.cart-item').remove();
...
var cancelOrderFailure = function cancelOrderFailure() {
  $('#cart-message').text('Error canceling order').css('color', 'red');
};

var getHistorySuccess = function getHistorySuccess(data) {
  var historyHTML = historyTemplate({ carts: data.carts });
  $('#order-history').html(historyHTML);
};

var getHistoryFailure = function getHistoryFailure() {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<!-- template to display cart -->\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.orderTotal : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "<div class=\"carts-content\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n"
    + ((stack1 = helpers.blockHelperMissing.call(depth0,alias1(((stack1 = blockParams[1][0]) != null ? stack1.pastOrder : stack1), depth0),{"name":"cart.pastOrder","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      <h5><strong>Order Total:</strong> $"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.orderTotalUSD : stack1), depth0))
    + "</h5>\n      <br>\n    </div>\n  </div>\n</div>\n";
},"3":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "      <h5><strong>Item Name:</strong> "
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</h5>\n      <h5><strong>Item Price:</strong> "
    + alias4(((helper = (helper = helpers.price || (depth0 != null ? depth0.price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"price","hash":{},"data":data}) : helper)))
    + "</h5>\n      <h5><strong>Quantity:</strong> "
    + alias4(((helper = (helper = helpers.quantity || (depth0 != null ? depth0.quantity : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"quantity","hash":{},"data":data}) : helper)))
    + "</h5>\n";
},"5":function(container,depth0,helpers,partials,data) {
    return "  <h5>--Discarded Order--</h5>\n  <br>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.carts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
